...
var es_bulk_insert = function elasticsearch_bulk_insert(listCounters, listTimerData, listGaugeData) {
      ...
      for (key in listCounters) {
        payload += '{"index":{"_index":"'+statsdIndex+'","_type":"statsd"}}'+"\n";
        payload += '{';
        innerPayload = '';
...
*/
  ...
  es_bulk_insert(array_counts, array_timer_data, array_gauges);
